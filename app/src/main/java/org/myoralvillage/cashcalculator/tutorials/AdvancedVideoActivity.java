...
public class AdvancedVideoActivity extends AppCompatActivity  implements View.OnClickListener  {
    ...
    private void switchtoSplash() {
        Intent intent = new Intent(AdvancedVideoActivity.this, SplashActivity.class);
